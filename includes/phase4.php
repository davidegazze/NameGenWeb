...
w2=window.open("core/runjava.php", "vis","location=0,status=0,scrollbars=0,resizable=0,width=1200,height=750");
...
<form action="core/generatefile.php" method="GET" target="downloadframe">
	<fieldset style="width:400px;height:100px;float:left">
...
<fieldset style="width:400px;height:100px;float:right">
...
<br /><h4>Web-Based Visualiser</h4>
<p>Alternatively you may use our <a href="#" onClick="javascript: warnPrompt();">experimental JavaScript visualiser</a> to explore your network from your web browser.</p>
