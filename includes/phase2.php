...
?>
<div style="width:150px;height:200px;margin-left:auto;margin-right:auto;text-align:center;line-height:200px">
...
flush();	
	...
	foreach ($_GET as $key => $value) {
		...
		if (($key!="download") && ($key!="page")) {
		$attribute_string.=",".$key;
		}
	}
	
	$friend_list = $_SESSION['friend_list']['data'];
	$chunk = array_chunk($friend_list, 500);
...
<script> window.location.href='index.php?page=phase3'</script>
